          ...
          {(speaker, index) => (
            <div class="flex flex-col gap-2">
              <div class="flex items-center gap-2">
                <input
                  type="text"
                  class="w-1/2 p-2 border border-gray-500/30 bg-sky-100 text-gray-950 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                  placeholder="Speaker name"
                  value={speaker.speaker}
                  onInput={(e) => props.updateSpeaker(index(), 'speaker', e.currentTarget.value)}
                />
                <select
                  class="w-1/2 p-2 border border-gray-500/30 bg-sky-100 text-gray-950 rounded-md"
