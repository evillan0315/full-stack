import { For, onMount, onCleanup, type JSX, createSignal, createEffect } from 'solid-js';
...
export default function FileTabs(): JSX.Element {
 ...
 // --- New Function: handleCloseAllTabs ---
  ...
  return (
    <>
      <div id="tabsContainer" class="flex flex-grow items-center overflow-hidden"> {/* Changed flex-col to flex, removed px-0 */}
  ...
  />
        ...
        <Show when={showScrollButtons()}>
          <Button icon="mdi:chevron-left" variant="outline" size="sm" class="flex-shrink-0 mx-1" onClick={() => scrollBy(-150)} />
        </Show>
