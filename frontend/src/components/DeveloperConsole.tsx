...
export default function DeveloperConsole() {
  ...
  return (
    <div class="bg-gray-950 text-gray-100 border-t border-gray-700">
      <div class="flex border-b border-gray-700 items-center">
        <Button
          variant="secondary"
        ...
        <div class="ml-auto">
          <Button variant="secondary" class="px-2 py-2 bg-gray-900 hover:bg-gray-800" onClick={openDeveloperSettings}>
